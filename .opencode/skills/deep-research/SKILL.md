...
根据调研主题创建独立文件夹（默认根目录为 `myk/调研笔记/`）：

```bash
mkdir -p "myk/调研笔记/{主题名}/images"
```
...
```bash
# 架构图
python .opencode/skill/image-service/scripts/research_image.py \
  -t arch \
  -n "Ralph Loop 核心架构" \
  -c "展示 Prompt、Agent、Stop Hook、Files 四个模块的循环关系" \
  -o "myk/调研笔记/{主题名}/images/architecture.png"
...
python .opencode/skill/image-service/scripts/research_image.py \
  ...
  -o "myk/调研笔记/{主题名}/images/flow.png"
...
python .opencode/skill/image-service/scripts/research_image.py \
  ...
  -o "myk/调研笔记/{主题名}/images/comparison.png"
...
python .opencode/skill/image-service/scripts/research_image.py \
  ...
  -o "myk/调研笔记/{主题名}/images/concept.png"
```
...
# 格式化 Word
python ../../../.opencode/skill/deep-research/scripts/format_docx.py "{主题名}调研报告.docx"
```
...
用法：
```bash
python .opencode/skill/deep-research/scripts/format_docx.py "输入.docx" ["输出.docx"]
```
...
# 4. 生成信息图
python .opencode/skill/image-service/scripts/text_to_image.py "技术架构图..." --output "myk/调研笔记/Ralph-Loop/images/architecture.png"
...
python ../../../.opencode/skill/deep-research/scripts/format_docx.py "Ralph-Loop调研报告.docx"
```
