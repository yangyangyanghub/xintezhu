...
export type MemoryType = 'identity' | 'preference' | 'habit' | 'workflow' | 'project' | 'decision' | 'pattern' | 'error_solution' | 'observation' | 'event';
export type MemoryStatus = 'new' | 'active' | 'superseded' | 'forgotten' | 'archived' | 'reverted';
...
export type EventType = 'message.updated' | 'file.edited' | 'session.created' | 'session.idle' | 'session.compacted' | 'git.commit' | 'test.result' | 'build.result';
...
export type AuditActionType = 'ingest' | 'classify' | 'promote' | 'rollback' | 'project' | 'forget' | 'update' | 'delete';
