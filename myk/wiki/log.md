...
## [2026-05-15] ingest | Multica 官方文档参考

- 使用 webfetch 从 multica.ai/docs/zh 抓取全部 28 个页面内容
- 涵盖：核心架构、三种使用方式、自部署指南、工作区与团队、Issue/任务系统、Agent/Skill/Squad、守护进程与运行时、AI 工具对照表、CLI 速查、环境变量配置
- 创建 `topics/Multica-官方文档参考.md`
- 关联现有知识库：[[synthesis/多Agent-平台对比-Multica-OpenCode-OpenClaw]]、[[concepts/Agent-as-Teammate]]
- 更新 index.md，添加新条目

---

*日志更新时间：2026-05-15*
- wiki 页面总数：**36 页** (topics 24 + concepts 12 + synthesis 6)
